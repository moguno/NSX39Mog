...
namespace NSX39Mog
{
    class Constants
    {
        ...
        public static List<ComboItem> Reverbs = new List<ComboItem>()
            {
        ...
        public static List<ComboItem> Choruses = new List<ComboItem>
            {
                new ComboItem() { Key = "off", Data = new byte[] { 0x00, 0x00 }},
        ...
        public static List<ComboItem> VarEffects = new List<ComboItem>
            {
