...
namespace NSX39Mog
{
    class Constants
    {
        public static ComboItem<int>[] Channels = new ComboItem<int>[] {
                new ComboItem<int> { Key = "Instrument", Data = 1 },
                new ComboItem<int> { Key = "Drums", Data = 9 },
            };


        public static List<ComboItem<byte>> VibTypes = new List<ComboItem<byte>> {
        ...
        public static List<ComboItem<byte>> Programs = new List<ComboItem<byte>> {
                new ComboItem<byte> { Key = "Acoustic Piano", Data = 0 },
                new ComboItem<byte> { Key = "Bright Piano", Data = 1 },
                new ComboItem<byte> { Key = "Electric Grand Piano", Data = 2 },
                new ComboItem<byte> { Key = "Honky-tonk Piano", Data = 3 },
                new ComboItem<byte> { Key = "Electric Piano", Data = 4 },
                new ComboItem<byte> { Key = "Electric Piano 2", Data = 5 },
                new ComboItem<byte> { Key = "Harpsichord", Data = 6 },
                new ComboItem<byte> { Key = "Clavi", Data = 7 },
                new ComboItem<byte> { Key = "Celesta", Data = 8 },
                new ComboItem<byte> { Key = "Glockenspiel", Data = 9 },
                new ComboItem<byte> { Key = "Musical box", Data = 10 },
                new ComboItem<byte> { Key = "Vibraphone", Data = 11 },
                new ComboItem<byte> { Key = "Marimba", Data = 12 },
                new ComboItem<byte> { Key = "Xylophone", Data = 13 },
                new ComboItem<byte> { Key = "Tubular Bell", Data = 14 },
                new ComboItem<byte> { Key = "Dulcimer", Data = 15 },
                new ComboItem<byte> { Key = "Drawbar Organ", Data = 16 },
                new ComboItem<byte> { Key = "Percussive Organ", Data = 17 },
                new ComboItem<byte> { Key = "Rock Organ", Data = 18 },
                new ComboItem<byte> { Key = "Church organ", Data = 19 },
                new ComboItem<byte> { Key = "Reed organ", Data = 20 },
                new ComboItem<byte> { Key = "Accordion", Data = 21 },
                new ComboItem<byte> { Key = "Harmonica", Data = 22 },
                new ComboItem<byte> { Key = "Tango Accordion", Data = 23 },
                new ComboItem<byte> { Key = "Acoustic Guitar (nylon)", Data = 24 },
                new ComboItem<byte> { Key = "Acoustic Guitar (steel)", Data = 25 },
                new ComboItem<byte> { Key = "Electric Guitar (jazz)", Data = 26 },
                new ComboItem<byte> { Key = "Electric Guitar (clean)", Data = 27 },
                new ComboItem<byte> { Key = "Electric Guitar (muted)", Data = 28 },
                new ComboItem<byte> { Key = "Overdriven Guitar", Data = 29 },
                new ComboItem<byte> { Key = "Distortion Guitar", Data = 30 },
                new ComboItem<byte> { Key = "Guitar harmonics", Data = 31 },
                new ComboItem<byte> { Key = "Acoustic Bass", Data = 32 },
                new ComboItem<byte> { Key = "Electric Bass (finger)", Data = 33 },
                new ComboItem<byte> { Key = "Electric Bass (pick)", Data = 34 },
                new ComboItem<byte> { Key = "Fretless Bass", Data = 35 },
                new ComboItem<byte> { Key = "Slap Bass 1", Data = 36 },
                new ComboItem<byte> { Key = "Slap Bass 2", Data = 37 },
                new ComboItem<byte> { Key = "Synth Bass 1", Data = 38 },
                new ComboItem<byte> { Key = "Synth Bass 2", Data = 39 },
                new ComboItem<byte> { Key = "Violin", Data = 40 },
                new ComboItem<byte> { Key = "Viola", Data = 41 },
                new ComboItem<byte> { Key = "Cello", Data = 42 },
                new ComboItem<byte> { Key = "Double bass", Data = 43 },
                new ComboItem<byte> { Key = "Tremolo Strings", Data = 44 },
                new ComboItem<byte> { Key = "Pizzicato Strings", Data = 45 },
                new ComboItem<byte> { Key = "Orchestral Harp", Data = 46 },
                new ComboItem<byte> { Key = "Timpani", Data = 47 },
                new ComboItem<byte> { Key = "String Ensemble 1", Data = 48 },
                new ComboItem<byte> { Key = "String Ensemble 2", Data = 49 },
                new ComboItem<byte> { Key = "Synth Strings 1", Data = 50 },
                new ComboItem<byte> { Key = "Synth Strings 2", Data = 51 },
                new ComboItem<byte> { Key = "Voice Aahs", Data = 52 },
                new ComboItem<byte> { Key = "Voice Oohs", Data = 53 },
                new ComboItem<byte> { Key = "Synth Voice", Data = 54 },
                new ComboItem<byte> { Key = "Orchestra Hit", Data = 55 },
                new ComboItem<byte> { Key = "Trumpet", Data = 56 },
                new ComboItem<byte> { Key = "Trombone", Data = 57 },
                new ComboItem<byte> { Key = "Tuba", Data = 58 },
                new ComboItem<byte> { Key = "Muted Trumpet", Data = 59 },
                new ComboItem<byte> { Key = "French horn", Data = 60 },
                new ComboItem<byte> { Key = "Brass Section", Data = 61 },
                new ComboItem<byte> { Key = "Synth Brass 1", Data = 62 },
                new ComboItem<byte> { Key = "Synth Brass 2", Data = 63 },
                new ComboItem<byte> { Key = "Soprano Sax", Data = 64 },
                new ComboItem<byte> { Key = "Alto Sax", Data = 65 },
                new ComboItem<byte> { Key = "Tenor Sax", Data = 66 },
                new ComboItem<byte> { Key = "Baritone Sax", Data = 67 },
                new ComboItem<byte> { Key = "Oboe", Data = 68 },
                new ComboItem<byte> { Key = "English Horn", Data = 69 },
                new ComboItem<byte> { Key = "Bassoon", Data = 70 },
                new ComboItem<byte> { Key = "Clarinet", Data = 71 },
                new ComboItem<byte> { Key = "Piccolo", Data = 72 },
                new ComboItem<byte> { Key = "Flute", Data = 73 },
                new ComboItem<byte> { Key = "Recorder", Data = 74 },
                new ComboItem<byte> { Key = "Pan Flute", Data = 75 },
                new ComboItem<byte> { Key = "Blown Bottle", Data = 76 },
                new ComboItem<byte> { Key = "Shakuhachi", Data = 77 },
                new ComboItem<byte> { Key = "Whistle", Data = 78 },
                new ComboItem<byte> { Key = "Ocarina", Data = 79 },
                new ComboItem<byte> { Key = "Lead 1 (square)", Data = 80 },
                new ComboItem<byte> { Key = "Lead 2 (sawtooth)", Data = 81 },
                new ComboItem<byte> { Key = "Lead 3 (calliope)", Data = 82 },
                new ComboItem<byte> { Key = "Lead 4 (chiff)", Data = 83 },
                new ComboItem<byte> { Key = "Lead 5 (charang)", Data = 84 },
                new ComboItem<byte> { Key = "Lead 6 (voice)", Data = 85 },
                new ComboItem<byte> { Key = "Lead 7 (fifths)", Data = 86 },
                new ComboItem<byte> { Key = "Lead 8 (bass + lead)", Data = 87 },
                new ComboItem<byte> { Key = "Pad 1 (Fantasia)", Data = 88 },
                new ComboItem<byte> { Key = "Pad 2 (warm)", Data = 89 },
                new ComboItem<byte> { Key = "Pad 3 (polysynth)", Data = 90 },
                new ComboItem<byte> { Key = "Pad 4 (choir)", Data = 91 },
                new ComboItem<byte> { Key = "Pad 5 (bowed)", Data = 92 },
                new ComboItem<byte> { Key = "Pad 6 (metallic)", Data = 93 },
                new ComboItem<byte> { Key = "Pad 7 (halo)", Data = 94 },
                new ComboItem<byte> { Key = "Pad 8 (sweep)", Data = 95 },
                new ComboItem<byte> { Key = "FX 1 (rain)", Data = 96 },
                new ComboItem<byte> { Key = "FX 2 (soundtrack)", Data = 97 },
                new ComboItem<byte> { Key = "FX 3 (crystal)", Data = 98 },
                new ComboItem<byte> { Key = "FX 4 (atmosphere)", Data = 99 },
                new ComboItem<byte> { Key = "FX 5 (brightness)", Data = 100 },
                new ComboItem<byte> { Key = "FX 6 (goblins)", Data = 101 },
                new ComboItem<byte> { Key = "FX 7 (echoes)", Data = 102 },
                new ComboItem<byte> { Key = "FX 8 (sci-fi)", Data = 103 },
                new ComboItem<byte> { Key = "Sitar", Data = 104 },
                new ComboItem<byte> { Key = "Banjo", Data = 105 },
                new ComboItem<byte> { Key = "Shamisen", Data = 106 },
                new ComboItem<byte> { Key = "Koto", Data = 107 },
                new ComboItem<byte> { Key = "Kalimba", Data = 108 },
                new ComboItem<byte> { Key = "Bagpipe", Data = 109 },
                new ComboItem<byte> { Key = "Fiddle", Data = 110 },
                new ComboItem<byte> { Key = "Shanai", Data = 111 },
                new ComboItem<byte> { Key = "Tinkle Bell", Data = 112 },
                new ComboItem<byte> { Key = "Agogo", Data = 113 },
                new ComboItem<byte> { Key = "Steel Drums", Data = 114 },
                new ComboItem<byte> { Key = "Woodblock", Data = 115 },
                new ComboItem<byte> { Key = "Taiko Drum", Data = 116 },
                new ComboItem<byte> { Key = "Melodic Tom", Data = 117 },
                new ComboItem<byte> { Key = "Synth Drum", Data = 118 },
                new ComboItem<byte> { Key = "Reverse Cymbal", Data = 119 },
                new ComboItem<byte> { Key = "Guitar Fret Noise", Data = 120 },
                new ComboItem<byte> { Key = "Breath Noise", Data = 121 },
                new ComboItem<byte> { Key = "Seashore", Data = 122 },
                new ComboItem<byte> { Key = "Bird Tweet", Data = 123 },
                new ComboItem<byte> { Key = "Telephone Ring", Data = 124 },
                new ComboItem<byte> { Key = "Helicopter", Data = 125 },
                new ComboItem<byte> { Key = "Applause", Data = 126 },
                new ComboItem<byte> { Key = "Gunshot", Data = 127 },
            };
